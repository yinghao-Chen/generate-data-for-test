...
@Slf4j
@Component
public class InitProvinceData implements CommandLineRunner, DisposableBean {

    @Override
    public void run(String... args) throws Exception {
        ClassPathResource res1 = new ClassPathResource("data/province.txt");
        try(InputStream inputStream = res1.getInputStream();
            ...
            DataCache.PROVINCE_LIST.addAll(Arrays.stream(lines).map(String::trim).collect(Collectors.toList()));
        }catch (IOException e) {
